            ...
            <div className="reveal">
              <div className="split-skyline" style={{ aspectRatio: '4/5' }}>
                <svg viewBox="0 0 400 500" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" aria-label="Dubai and Canary Wharf">
                  <defs>
                    <clipPath id="clip-dubai"><polygon points="0,0 400,0 0,500"/></clipPath>
                    <clipPath id="clip-london"><polygon points="400,0 400,500 0,500"/></clipPath>
                  ...
                  <g clipPath="url(#clip-dubai)">
                    ...
                    {/* foreground towers (Dubai Marina-ish twists) */}
                  ...
                  {/* corner labels */}
                  <text x="22" y="30" fill="oklch(30% 0.01 50)" fontFamily="ui-monospace, monospace" fontSize="9" letterSpacing="1.5">DUBAI</text>
                  <text x="378" y="488" textAnchor="end" fill="oklch(30% 0.01 230)" fontFamily="ui-monospace, monospace" fontSize="9" letterSpacing="1.5">CANARY WHARF</text>
                </svg>
              </div>
            </div>
      ...
      <section className="section">
        <div className="container">
          <div className="section-label reveal" style={{ justifyContent: 'space-between' }}>
            ...
            <a onClick={() => onNavigate('insights')} className="scroll-hint" style={{ cursor: 'pointer' }}>
              All insights →
            </a>
          </div>
          <div className="insight-grid">
            {INSIGHTS.slice(0, 3).map((it, i) => (
              <div key={it.id} className="insight reveal" style={{ transitionDelay: `${i * 80}ms` }} onClick={() => onNavigate('insights')}>
                <div className="meta">
