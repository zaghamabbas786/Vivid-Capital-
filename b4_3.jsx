      ...
      <section className="section">
        <div className="container">
          <div className="grid-asym">
            ...
            <div className="reveal d1" style={{ display: 'grid', gap: 24, paddingTop: 16, borderTop: '1px solid var(--rule)' }}>
              <div className="display-sm" style={{ margin: 0, maxWidth: '20ch' }}>
                Coming soon.
              </div>
              <p className="body" style={{ margin: 0, maxWidth: '52ch' }}>
                ...
                to the distribution list, please get in touch via the contact page.
              </p>
            </div>
          </div>
        </div>
